...
, 			{
				"box" : 				{
					"annotation" : "Update rate of the camera, in milliseconds",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-85",
					"maxclass" : "number",
...
, 			{
				"box" : 				{
					"annotation" : "x value of the upper right corner of the desktop crop",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : " y value of the upper right corner of the desktop crop",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "y size of desktop crop",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "x size of desktop crop",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "Turn video color synth on or off",
					"border" : 1,
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-24",
...
, 			{
				"box" : 				{
					"align" : 1,
					"annotation" : "0: no looping | 1: looping on | 2: palindrom ",
					"arrow" : 0,
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "y size of noise matrix",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "x size of noise matrix",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "Resolution of captured image",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					"annotation" : "Select size of video playback",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
