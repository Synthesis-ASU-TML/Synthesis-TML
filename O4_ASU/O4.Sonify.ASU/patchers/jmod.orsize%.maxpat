...
, 			{
				"box" : 				{
					"annotation" : "Zoom image in Y-direction.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-24",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					"annotation" : "Boundary mode for values outside the range (0, width) (0, height). <br /> 0 = ignore: Values that exceed the limits are ignored.<br /> 1 = clear: Values that exceed the limits are set to 0.<br /> 2 = wrap: Values that exceed the limits are wrapped around to the opposite limit with a modulo operation.<br /> 3 = clip: Values are limited not to exceed width or height.<br /> 4 = fold: Values that exceed the limits are folded back in the opposite.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-12",
...
, 			{
				"box" : 				{
					"annotation" : "Offset image in Y-direction",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-8",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					"annotation" : "Offset image in X-direction",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-7",
					"maxclass" : "flonum",
...
, 			{
				"box" : 				{
					"annotation" : "Rotate image - in degrees",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-16",
					"maxclass" : "number",
...
, 			{
				"box" : 				{
					"annotation" : "Zoom image in X-direction.",
					"fontname" : "Verdana",
					"fontsize" : 10.0,
					"id" : "obj-30",
					"maxclass" : "flonum",
