...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"items" : [ "/waterOut", ",", "/water", ",", "/crisp1Out", ",", "/crisp1", ",", "/highSusOut", ",", "/highSus1", ",", "/myUes", ",", "/cueManager", ",", "/brcosa%", ",", "/orsize%", ",", "/input%", ",", "/motion%", ",", "/centerX", ",", "Glitch-pers.aif", ",", "/centerY", ",", "/all-fixed", ",", "/height", ",", "/area", ",", "/width", ",", "/all", ",", "/large", ",", "/small", ",", "/nav", ",", "/subWoof", ",", "/sources", ",", "/ambicontrol", ",", "/PVout", ",", "/eaCrumOut", ",", "/PVSpectral", ",", "/EaCrum", ",", "/lowVarOut", ",", "/lowSus1", ",", "/winderOut", ",", "/winder", ",", "/ED-rogs-3", ",", "/ED-rogs-2", ",", "/ED-rogs-1", ",", "/glitchOut", ",", "/glitch", ",", "/pant2Out", ",", "/scratch", ",", "/pant1Out", ",", "/glass", ",", "/sf-nim", ",", "/sf-whisperscape", ",", "/sf-ilya", ",", "/sf-bozzi2", ",", "/Glass-output~", ",", "/sf-bozzi1" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1112.0, 291.0, 103.0, 16.0 ],
					"presentation" : 1,
