...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 300.0, 93.0, 51.0 ],
					"text" : "***incoming osc music be prepended with /stream"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 258.5, 399.0, 116.0, 29.0 ],
					"text" : "outlet 1: osc stream (recording in progress)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 156.0, 353.0, 93.0, 29.0 ],
					"text" : "inlet 1: jitter matrix + osc stream"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 480.0, 300.0, 110.0, 64.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
					"size" : 3,
					"spacing" : 2
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 264.0, 75.0, 18.0 ],
					"text" : "pack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 480.0, 230.0, 103.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 300.0, 150.0, 40.0 ],
					"text" : "/stream/x 0.591197\n/stream/y 0.533333\n/stream/quantity 0.000924479",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 629.0, 165.0, 268.776794, 199.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 42.0, 240.0, 18.0 ],
					"text" : "example: save/load synchronized video + osc data"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 28.0, 20.0, 212.0, 22.0 ],
					"text" : "o4.track"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 438.0, 150.0, 51.0 ],
					"text" : "/x 0.734574\n/y 0.451064\n/quantity 0.000611979\n/frame \"frame\" 336",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 309.0, 147.0, 111.5, 18.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 495.5, 165.0, 125.0, 51.0 ],
					"text" : "/x 0.534677\n/y 0.566667\n/quantity 0.000403646\n/frame \"frame\" 99",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 249.0, 264.0, 102.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "FullPacket" ],
					"patching_rect" : [ 249.0, 230.0, 143.5, 18.0 ],
					"text" : "o.route /x /y /quantity"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "FullPacket" ],
					"patching_rect" : [ 249.0, 204.0, 77.0, 18.0 ],
					"text" : "o.route /motion"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-9",
					"maxclass" : "bpatcher",
					"name" : "o4.track_read.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "", "jit_matrix" ],
					"patching_rect" : [ 480.0, 57.0, 168.0, 81.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 249.0, 173.0, 79.0, 18.0 ],
					"text" : "jmod.motion2%"
				}
...
, 			{
				"box" : 				{
					"color" : [ 0.001349, 0.839216, 0.175015, 1.0 ],
					"fontname" : "Helvetica",
					"fontsize" : 10.0,
					"id" : "obj-30",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "FullPacket" ],
					"patching_rect" : [ 249.0, 300.0, 92.0, 16.0 ],
					"text" : "o.prepend /stream"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 68.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"id" : "obj-24",
					"maxclass" : "bpatcher",
					"name" : "o4.track_write.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 249.0, 353.0, 167.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 411.0, 295.0, 354.0, 295.0, 354.0, 337.0, 258.5, 337.0 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "o4.track_write.maxpat",
				"bootpath" : "/Users/julian/Synthesis/O4_ASU/O4.rhyth_abs/o4.track",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
