	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 191.0, 96.0, 163.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 45.0, 91.0, 139.0, 43.0 ],
					"text" : "imtr.analysis.stub NoteNumberInt @wanted Pitch @name pitch-to-midi"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 165.0, 31.0, 19.0 ],
					"text" : "ftom"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"hidden" : 0,
					"midpoints" : [ 114.5, 198.0, 221.0, 198.0, 221.0, 76.0, 114.5, 76.0 ],
					"source" : [ "obj-6", 0 ]
				}
