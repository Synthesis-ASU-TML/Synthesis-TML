{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 748.0, 637.0, 518.0, 382.0 ],
		"bglocked" : 0,
		"defrect" : [ 748.0, 637.0, 518.0, 382.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 135.0, 52.0, 19.0 ],
					"text" : "route out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 90.0, 165.0, 138.035156, 73.0 ],
					"presentation_linecount" : 5,
					"presentation_rect" : [ 90.0, 165.0, 138.035156, 73.0 ],
					"text" : [ "_($sortee rows ($1 size))", "_($data set $1)", "_($ind ramp 0 ($1 size))", "_($sortee sort);", "_($*2 set $ind)" ]
				}

			}
, 			{
				"box" : 				{
					"description" : "fvec $sortee col 0",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"ftm_scope" : 0,
					"id" : "obj-1",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.0, 90.0, 142.666016, 19.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 240.0, 90.0, 142.666016, 19.0 ],
					"scope" : 0,
					"text" : "fvec $sortee col 0"
				}

			}
, 			{
				"box" : 				{
					"description" : "fvec $sortee col 1",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"ftm_scope" : 0,
					"id" : "obj-3",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.0, 120.0, 134.666016, 19.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 240.0, 120.0, 134.666016, 19.0 ],
					"scope" : 0,
					"text" : "fvec $sortee col 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 240.0, 60.0, 101.666016, 19.0 ],
					"persistence" : 0,
					"presentation_rect" : [ 240.0, 60.0, 101.666016, 19.0 ],
					"scope" : 0,
					"text" : "fmat 0 2"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 69.0, 507.0, 640.0, 480.0 ],
						"bglocked" : 0,
						"defrect" : [ 69.0, 507.0, 640.0, 480.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 240.0, 161.0, 67.0 ],
					"text" : "use of file-wise descriptor generation for just some descriptors, given as argument: Declare like tempmod of these descr. only"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 104.0, 119.0, 19.0 ],
					"text" : "wanted descriptor fcol in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 195.0, 60.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 15.0, 60.0, 169.0, 31.0 ],
					"text" : "imtr.analysis.stub @name rank @wanted #1"
				}
