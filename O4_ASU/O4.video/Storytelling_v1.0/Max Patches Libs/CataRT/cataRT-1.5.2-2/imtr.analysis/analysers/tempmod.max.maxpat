{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 920.0, 513.0, 435.0, 370.0 ],
		"bglocked" : 0,
		"defrect" : [ 920.0, 513.0, 435.0, 370.0 ],
...
,
					"patching_rect" : [ 30.0, 170.0, 60.0, 43.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
						"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 260.0, 137.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 150.0, 270.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 210.0, 110.0, 52.0, 19.0 ],
					"text" : "route out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 110.0, 53.0, 19.0 ],
					"text" : "inst. fmat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 240.0, 70.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 210.0, 135.0, 53.491699, 17.0 ],
					"presentation_rect" : [ 210.0, 135.0, 53.491699, 17.0 ],
					"text" : [ "_outmax $1" ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 30.0, 75.0, 199.0, 31.0 ],
					"text" : "imtr.analysis.stub @name max @wanted #1 #2 #3 #4 #5 #6 #7 #8 #9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 170.0, 240.0, 137.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 120.0, 170.0, 72.0, 55.0 ],
					"saved_object_attributes" : 					{
						"ftm_scope" : 2,
						"ftm_objref_conv" : 0
					}
,
					"text" : "mnm.minmax @mode col @scalar off @outmax fvec"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 270.0, 17.0, 17.0 ]
				}
