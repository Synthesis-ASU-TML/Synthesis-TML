{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 4.0, 44.0, 1308.0, 628.0 ],
		"bglocked" : 0,
		"defrect" : [ 4.0, 44.0, 1308.0, 628.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 67.0, 134.0, 50.0, 20.0 ],
					"id" : "obj-29",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "atoi",
					"patching_rect" : [ 67.0, 108.0, 46.0, 20.0 ],
					"id" : "obj-27",
					"numinlets" : 3,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 183.0, 294.0, 289.0, 20.0 ],
					"id" : "obj-51",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "outlet",
					"patching_rect" : [ 154.0, 291.0, 25.0, 25.0 ],
					"id" : "obj-49",
					"numinlets" : 1,
					"numoutlets" : 0,
					"comment" : ""
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"patching_rect" : [ 199.149231, 76.735596, 172.0, 62.0 ],
					"id" : "obj-47",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					"maxclass" : "number",
					"patching_rect" : [ 66.106552, 211.481873, 50.0, 20.0 ],
					"id" : "obj-22",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "switch 26",
					"patching_rect" : [ 154.483093, 257.742584, 826.0, 20.0 ],
					"id" : "obj-20",
					"numinlets" : 27,
					"fontname" : "Arial",
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 67.275047, 79.271492, 129.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 185.527435, 223.936005, 824.0, 20.0 ],
					"id" : "obj-4",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 27,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 139.0, 196.0, 113.0, 20.0 ],
					"id" : "obj-2",
					"numinlets" : 1,
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 139.0, 169.0, 144.0, 20.0 ],
