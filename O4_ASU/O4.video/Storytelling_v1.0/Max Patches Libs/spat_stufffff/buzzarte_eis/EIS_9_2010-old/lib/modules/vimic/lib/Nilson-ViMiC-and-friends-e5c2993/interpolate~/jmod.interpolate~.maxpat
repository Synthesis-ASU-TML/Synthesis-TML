...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 435.0, 150.0, 19.0 ],
					"text" : "Speakers:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 230.0, 150.0, 19.0 ],
					"text" : "Source:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 466.0, 20.0, 150.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 471.0, 150.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 251.0, 43.0, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 531.0, 150.0, 592.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 471.0, 115.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 251.0, 23.0, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 531.0, 115.0, 606.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 471.0, 80.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.0, 43.0, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 531.0, 80.0, 579.0, 31.0 ],
					"text" : "jcom.parameter numDestinations @type integer @range/bounds 1 32 @range/clipmode both @description \"The number of speakers to diffuse to.\" @priority 3",
					"varname" : "voices[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 471.0, 45.0, 40.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.0, 23.0, 40.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 110.0, 196.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 161.0, 210.0, 54.0, 19.0 ],
					"text" : "jcom.in"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 425.0, 206.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 41.0, 85.0, 160.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 45.0, 72.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 176.0, 43.0, 72.0, 19.0 ],
					"text" : "Rolloff (dB):"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 171.0, 25.0, 73.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 176.0, 23.0, 73.0, 19.0 ],
					"text" : "Dimensions:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 45.0, 131.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 43.0, 130.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.0, 425.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 226.0, 350.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 355.0, 207.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 46.0, 290.0, 103.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 335.0, 49.0, 19.0 ],
					"text" : "mute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 161.0, 390.0, 95.0, 19.0 ],
					"text" : "jalg.interpolate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 6.0, 150.0, 414.0, 19.0 ],
					"text" : "jcom.hub @description \"multidimensional interpolation/mixing of audiostreams\"",
					"varname" : "jcom.hub"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 25.0, 110.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 23.0, 110.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 245.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 531.0, 45.0, 604.0, 31.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 50.5, 135.0, 18.0, 135.0, 18.0, 147.0, 15.5, 147.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-34", 0 ],
					"hidden" : 0,
					"midpoints" : [ 80.5, 135.0, 18.0, 135.0, 18.0, 147.0, 15.5, 147.0 ],
					"source" : [ "obj-8", 0 ]
				}
