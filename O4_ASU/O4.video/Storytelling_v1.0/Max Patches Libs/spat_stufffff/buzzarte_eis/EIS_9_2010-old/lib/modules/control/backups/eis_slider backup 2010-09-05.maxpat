...
,
					...
					"presentation_rect" : [ 661.0, 596.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-45",
									"items" : [ "#1", ",", "#1-cleardelays", ",", "#1-clearloop", ",", "#1-delays_modvalue", ",", "#1-delays_switchingspeed", ",", "#1-delaysmodvalue", ",", "#1-delaysswitchingspeed", ",", "#1-delaytime", ",", "#1-depth", ",", "#1-lexicondelaytime", ",", "#1-lexicondepth", ",", "#1-lexiconfeedback", ",", "#1-lexiconrate", ",", "#1-lexiconvolume", ",", "#1-lexiconwaveform", ",", "#1-looperdelaytime", ",", "#1-looperdepth", ",", "#1-looperfeedback", ",", "#1-looperrecord", ",", "#1-looperspeed", ",", "#1-loopervolume", ",", "#1-modulation", ",", "#1-number", ",", "#1-numberofdelays", ",", "#1-rate_0.", ",", "#1-rate_0._1.", ",", "#1-reverbdamping", ",", "#1-reverbdrylevel", ",", "#1-reverbsize", ",", "#1-reverbwetlevel", ",", "#1-spread", ",", "#1-spread_modulation", ",", "#1-vbap_radius", ",", "#1-vbap_speed", ",", "0", ",", "0-loopervolume", ",", "1-cleardelays", ",", "1-clearloop", ",", "1-delays_modvalue", ",", "1-delays_switchingspeed", ",", "1-heyheyhey", ",", "1-lexicondelaytime", ",", "1-lexicondepth", ",", "1-lexiconfeedback", ",", "1-lexiconrate", ",", "1-lexiconvolume", ",", "1-lexiconwaveform", ",", "1-looperrecord", ",", "1-looperspeed", ",", "1-loopervolume", ",", "1-modulation", ",", "1-number", ",", "1-numberofdelays", ",", "1-reverbdamping", ",", "1-reverbdrylevel", ",", "1-reverbsize", ",", "1-reverbwetlevel", ",", "1-spread", ",", "1-spread_modulation", ",", "1-vbap_radius", ",", "1-vbap_speed", ",", "2-cleardelays", ",", "2-clearloop", ",", "2-delays_modvalue", ",", "2-delays_switchingspeed", ",", "2-lexicondelaytime", ",", "2-lexicondepth", ",", "2-lexiconfeedback", ",", "2-lexiconrate", ",", "2-lexiconvolume", ",", "2-lexiconwaveform", ",", "2-looperrecord", ",", "2-looperspeed", ",", "2-loopervolume", ",", "2-modulation", ",", "2-number", ",", "2-numberofdelays", ",", "2-reverbdamping", ",", "2-reverbdrylevel", ",", "2-reverbsize", ",", "2-reverbwetlevel", ",", "2-spread", ",", "2-spread_modulation", ",", "2-vbap_radius", ",", "2-vbap_speed", ",", "a_slider_with_a_really_really_long_name", ",", "EIS_test_slider_1", ",", "EIS_test_slider_2", ",", "horixo", ",", "test", ",", "testtesttest", ",", "yourmom" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 							{
								"box" : 								{
									...
									"presentation_rect" : [ 595.0, 182.0, 0.0, 0.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"id" : "obj-45",
									"items" : [ "#1", ",", "#1-cleardelays", ",", "#1-clearloop", ",", "#1-delays_modvalue", ",", "#1-delays_switchingspeed", ",", "#1-looperrecord", ",", "#1-looperspeed", ",", "#1-loopervolume", ",", "#1-numberofdelays", ",", "1-cleardelays", ",", "1-clearloop", ",", "1-delays_modvalue", ",", "1-delays_switchingspeed", ",", "1-heyheyhey", ",", "1-lexicondelaytime", ",", "1-lexicondepth", ",", "1-lexiconfeedback", ",", "1-lexiconrate", ",", "1-lexiconvolume", ",", "1-lexiconwaveform", ",", "1-looperrecord", ",", "1-looperspeed", ",", "1-loopervolume", ",", "1-modulation", ",", "1-numberofdelays", ",", "1-reverbdamping", ",", "1-reverbdrylevel", ",", "1-reverbsize", ",", "1-reverbwetlevel", ",", "1-spread", ",", "1-spread_modulation", ",", "1-vbap_radius", ",", "1-vbap_speed", ",", "2-cleardelays", ",", "2-clearloop", ",", "2-delays_modvalue", ",", "2-delays_switchingspeed", ",", "2-lexicondelaytime", ",", "2-lexicondepth", ",", "2-lexiconfeedback", ",", "2-lexiconrate", ",", "2-lexiconvolume", ",", "2-lexiconwaveform", ",", "2-looperrecord", ",", "2-looperspeed", ",", "2-loopervolume", ",", "2-modulation", ",", "2-numberofdelays", ",", "2-reverbdamping", ",", "2-reverbdrylevel", ",", "2-reverbsize", ",", "2-reverbwetlevel", ",", "2-spread", ",", "2-spread_modulation", ",", "2-vbap_radius", ",", "2-vbap_speed" ],
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
									"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 191.0, 221.0, 118.0, 400.0 ],
						"bgcolor" : [ 0.843137, 0.839216, 0.772549, 0.827451 ],
						"bglocked" : 0,
						"defrect" : [ 191.0, 221.0, 118.0, 400.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
