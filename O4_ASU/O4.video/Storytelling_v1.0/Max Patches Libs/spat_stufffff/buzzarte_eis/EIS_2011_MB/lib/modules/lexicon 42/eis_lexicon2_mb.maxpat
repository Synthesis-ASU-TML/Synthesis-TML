{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -22.0, 253.0, 1420.0, 806.0 ],
		"bglocked" : 0,
		"defrect" : [ -22.0, 253.0, 1420.0, 806.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 793.0, 352.0, 72.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 700.0, 286.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 411.0, 70.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 725.0, 401.0, 63.0, 18.0 ],
					"text" : "disable $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 718.0, 287.0, 36.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 430.0, 70.0, 36.0, 20.0 ],
					"text" : "mute ",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 411.0, 47.0, 37.0, 17.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"pic" : "lexiconlogo.png",
					"presentation" : 1,
					"presentation_rect" : [ 409.0, 13.0, 52.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 306.0, 450.0, 129.0, 19.0 ],
					"text" : "jpsp42_20110415_mb #1",
					"varname" : "jpsp42"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 592.5, 367.0, 407.166656, 367.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 538.5, 367.0, 388.833344, 367.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 345.5, 367.0, 333.833344, 367.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 399.5, 367.0, 352.166656, 367.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 484.5, 367.0, 370.5, 367.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 645.5, 367.0, 425.5, 367.0 ],
					"source" : [ "obj-8", 0 ]
				}
