{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1557.0, -85.0, 1563.0, 855.0 ],
		"bglocked" : 0,
		"defrect" : [ 1557.0, -85.0, 1563.0, 855.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 836.0, 182.0, 0.0, 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 630.0, 240.0, 173.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 600.0, 195.0, 94.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 270.0, 615.0, 94.0, 19.0 ],
					"types" : [  ],
					"varname" : "left_menu"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 135.0, 266.0, 18.0 ],
					"text" : "/audio/gain 127."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 60.0, 360.0, 44.0, 20.0 ],
					"text" : "t 1.6 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 60.0, 300.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 555.0, 50.0, 32.0 ],
					"text" : "/audio/active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 510.0, 495.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 510.0, 525.0, 76.0, 20.0 ],
					"text" : "delay 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 540.0, 15.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 690.0, 50.0, 32.0 ],
					"text" : "/audio/active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 540.0, 105.0, 266.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 345.0, 105.0, 151.0, 18.0 ],
					"text" : "58.107006"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 60.0, 58.0, 20.0 ],
					"text" : "r 1-angle"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 150.0, 151.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 90.0, 440.0, 18.0 ],
...
,
					"patching_rect" : [ 435.0, 15.0, 51.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 540.0, 45.0, 76.0, 20.0 ],
					"text" : "delay 10000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 600.0, 75.0, 266.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 795.0, 225.0, 71.0, 20.0 ],
					"text" : "r~ 1-vbapin"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 289.0, 204.0, 124.0, 29.0 ],
									"text" : "set orientation 30 58 0."
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 98.0, 457.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 105.0, 147.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 135.0, 146.0, 17.0 ],
					"text" : "jcom.send jcom.remote.module.to"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1080.0, 210.0, 95.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.0, 600.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 510.0, 270.0, 300.0, 70.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 420.0, 607.0, 90.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 146.0, 439.0, 149.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 135.0, 459.0, 182.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 797.5, 459.0, 800.5, 459.0 ],
					"source" : [ "obj-190", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-176", 1 ],
					"hidden" : 0,
					"midpoints" : [ 800.5, 358.0, 812.0, 358.0, 812.0, 461.0, 800.5, 461.0 ],
					"source" : [ "obj-201", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 800.5, 367.5, 657.0, 367.5 ],
					"source" : [ "obj-201", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 1,
					"midpoints" : [ 519.5, 343.5, 783.5, 343.5 ],
					"source" : [ "obj-201", 0 ]
				}
