{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 72.0, 44.0, 1074.0, 706.0 ],
		"bglocked" : 0,
		"defrect" : [ 72.0, 44.0, 1074.0, 706.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 27.0, 648.0, 113.5, 19.0 ],
					"text" : "jcom.vimic~ 8 1",
					"varname" : "VIMIC"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 826.0, 312.0, 45.0, 17.0 ],
					"text" : "qlim 250"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 824.0, 332.0, 65.0, 20.0 ],
					"text" : "s #0_mics"
				}
					...
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 59.0, 319.0, 176.0, 46.0 ],
									"text" : "Module configured for $1 microphones. Order of Reflections is set to $2 ."
								}
...
, 											{
												"box" : 												{
													...
													"text" : "sprintf script new VIMIC newex 92 635 105 196617 jcom.vimic~ %ld %ld;\r"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 58.0, 220.0, 358.0, 20.0 ],
													"text" : "prepend script new VIMIC newex 92 635 105 196617 jcom.vimic~"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 57.0, 366.0, 56.0, 20.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 57.0, 387.0, 73.0, 20.0 ],
									"text" : "print ViMiC:"
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "int", "bang" ],
													"patching_rect" : [ 351.0, 111.0, 50.0, 19.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 105.0, 100.0, 32.5, 18.0 ],
													"text" : "$2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "int" ],
													"patching_rect" : [ 105.0, 121.0, 53.0, 20.0 ],
													"text" : "<= 8"
												}
...
, 											{
												"patchline" : 												{
													...
													"hidden" : 0,
													"midpoints" : [ 360.5, 88.0, 148.5, 88.0 ],
													"source" : [ "obj-2", 0 ]
												}
...
,
									"patching_rect" : [ 144.0, 655.0, 43.0, 20.0 ],
									"saved_object_attributes" : 									{
										"default_fontsize" : 10.0,
										"fontname" : "Verdana",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 5,
									"outlettype" : [ "", "", "", "", "" ],
									"patching_rect" : [ 173.0, 114.0, 103.0, 20.0 ],
									"text" : "route /aed /x /y /z"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 421.0, 135.0, 105.0, 62.0 ],
									"text" : "jcom.dataspace @dataspace gain @input midi @output linear"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 376.0, 626.0, 50.0, 17.0 ],
									"text" : "deferlow"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "bang", "bang", "int" ],
									"patching_rect" : [ 945.0, 176.0, 46.0, 17.0 ],
									"text" : "uzi 8 1",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 139.0, 245.0, 60.0, 20.0 ],
									"text" : "jcom.thru"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "/microphone.3/directivity/ratio 0.4"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 870.0, 57.0, 25.0, 25.0 ]
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 177.0, 361.0, 149.0, 19.0 ],
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 4,
													"outlettype" : [ "", "", "", "" ],
													"patching_rect" : [ 177.0, 100.0, 184.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 760.0, 115.0, 97.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 895.0, 58.0, 88.0, 20.0 ],
									"text" : "non-matching"
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 385.5, 648.5, 153.5, 648.5 ],
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"hidden" : 0,
									"midpoints" : [ 1130.0, 652.0, 177.5, 652.0 ],
									"source" : [ "obj-15", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"hidden" : 0,
									"midpoints" : [ 180.5, 223.0, 148.5, 223.0 ],
									"source" : [ "obj-3", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"hidden" : 0,
									"midpoints" : [ 301.5, 231.0, 148.5, 231.0 ],
									"source" : [ "obj-6", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"hidden" : 0,
									"midpoints" : [ 248.5, 84.0, 862.0, 84.0, 862.0, 47.0, 879.5, 47.0 ],
									"source" : [ "obj-60", 1 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"hidden" : 0,
									"midpoints" : [ 847.5, 136.0, 767.5, 136.0 ],
									"source" : [ "obj-7", 2 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-2", 0 ],
									"hidden" : 0,
									"midpoints" : [ 767.5, 237.0, 148.5, 237.0 ],
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 925.0, 306.0, 104.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"fontname" : "Arial",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 75.0, 51.0, 27.0, 27.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 51.0, 27.0, 27.0 ],
					"varname" : "Vol0"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-33", 0 ],
					"hidden" : 0,
					"midpoints" : [ 1019.5, 478.0, 430.5, 478.0 ],
					"source" : [ "obj-46", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-61", 0 ],
					"hidden" : 0,
					"midpoints" : [ 934.5, 413.0, 680.5, 413.0 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 246.5, 182.5, 934.5, 182.5 ],
					"source" : [ "obj-74", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 138.5, 240.0, 422.5, 240.0 ],
					"source" : [ "obj-74", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 192.5, 199.0, 632.5, 199.0 ],
					"source" : [ "obj-74", 2 ]
				}
