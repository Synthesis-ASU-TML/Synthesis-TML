...
,
		"rect" : [ 819.0, 44.0, 355.0, 439.0 ],
		"bgcolor" : [ 1.0, 1.0, 1.0, 0.0 ],
		"bglocked" : 0,
		"defrect" : [ 819.0, 44.0, 355.0, 439.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 230.0, 600.0, 37.0, 18.0 ],
					"text" : "pass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.0, 119.0, 47.0, 16.0 ],
					"text" : "Pitch $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 52.0, 81.0, 62.0, 18.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.0, 65.0, 67.0, 18.0 ],
					"text" : "loadmess 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 380.0, 244.0, 54.0, 29.0 ],
					"text" : "loadmess 55"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.0, 345.0, 56.0, 29.0 ],
					"text" : "loadmess 0.56"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.0, 305.0, 76.0, 18.0 ],
					"text" : "loadmess 0.44"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 188.0, 194.0, 68.0, 18.0 ],
					"text" : "yin~ 1 60. 1.",
					"varname" : "Yin"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 54.096375, 65.0, 16.0, 16.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 477.386475, 375.529968, 105.0, 20.0 ],
					"text" : "s #0-Window"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.386475, 479.345459, 119.0, 20.0 ],
					"text" : "s #1_MIDI-Data"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 52.363647, 5.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 38.363647, 86.0, 36.0, 18.0 ],
					"text" : "proba"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 28.363647, 45.0, 42.0, 18.0 ],
					"text" : "window"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.363647, 86.0, 36.0, 18.0 ],
					"triscale" : 0.5,
					"varname" : "Proba"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.363647, 45.0, 26.0, 18.0 ],
					"triscale" : 0.5,
					"varname" : "Window"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 28.363647, 65.272705, 29.0, 18.0 ],
					"text" : "level"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.363647, 66.272705, 26.0, 18.0 ],
					"triscale" : 0.5,
					"varname" : "Level"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 4.363647, 25.0, 36.0, 18.0 ],
					"triscale" : 0.5,
					"varname" : "Quality"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 38.363647, 25.0, 42.0, 18.0 ],
					"text" : "qual"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 18.363647, 3.272705, 42.0, 20.0 ],
					"text" : "Pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 166.213623, 18.781097, 311.272766, 237.545471 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 2.0, 69.0, 107.0 ]
				}
