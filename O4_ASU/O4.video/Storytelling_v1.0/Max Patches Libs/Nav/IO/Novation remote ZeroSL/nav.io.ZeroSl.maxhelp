{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 25.0, 69.0, 694.0, 289.0 ],
		"bglocked" : 0,
		"defrect" : [ 25.0, 69.0, 694.0, 289.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"args" : [ "nav.io.ZeroSL", "for use with the Novation Remote ZeroSL MIDI Controller", 2009 ],
					"id" : "obj-3",
					"maxclass" : "bpatcher",
					"name" : "nav.banner.maxpat",
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 5.0, 443.0, 61.0 ]
				}
...
,
					"patching_rect" : [ 243.0, 70.0, 31.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 343.0, 90.0, 338.0, 192.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.0, 90.0, 338.0, 192.0 ]
				}
...
,
					"patching_rect" : [ 200.0, 70.0, 40.0, 17.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : "",
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 10.0, 70.0, 84.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 97.0, 70.0, 100.0, 17.0 ],
					"types" : [  ]
				}
