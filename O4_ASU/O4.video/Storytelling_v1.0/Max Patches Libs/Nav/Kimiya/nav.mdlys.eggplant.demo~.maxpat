...
,
		"rect" : [ 370.0, 44.0, 498.0, 490.0 ],
		"bglocked" : 0,
		"defrect" : [ 370.0, 44.0, 498.0, 490.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 610.0, 78.0, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 158.0, 33.0, 44.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 611.0, 18.0, 82.0, 15.0 ],
					"pictures" : [  ],
					"presentation" : 1,
					"presentation_rect" : [ 149.0, 80.0, 52.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
							"parameter_invisible" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.0, 78.0, 44.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 73.0, 15.0, 41.0, 18.0 ],
					"text" : "Modes:"
				}
...
,
					"patching_rect" : [ 506.0, 146.0, 131.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"fontname" : "Arial Bold",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 452.0, 94.0, 45.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 110.0, 17.0, 72.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
							"parameter_invisible" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 508.0, 78.0, 53.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 33.0, 57.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
							"parameter_invisible" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 564.0, 78.0, 44.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 109.0, 33.0, 45.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
							"parameter_invisible" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 193.0, 393.0, 297.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 193.0, 414.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 765.0, 698.0, 73.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 97.0, 423.0, 74.0, 20.0 ],
					"text" : "pitch Range"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.0, 758.0, 43.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.0, 463.0, 43.0, 20.0 ],
					"text" : "thresh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 661.0, 736.0, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 141.0, 463.0, 50.0, 20.0 ],
					"varname" : "thresh"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 63.0, 93.0, 123.0, 10.0 ],
					"prototypename" : "M4L.live.line.dark.H"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 810.0, 715.0, 48.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 143.0, 441.0, 48.0, 20.0 ],
					"varname" : "pRangeMax"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 757.0, 715.0, 48.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 95.0, 441.0, 48.0, 20.0 ],
					"varname" : "pRangeMin"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 181.0, 122.0, 22.0, 18.0 ],
					"text" : "ms"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 104.0, 122.0, 34.0, 18.0 ],
					"text" : "ramp:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 122.0, 102.0, 39.0, 18.0 ],
					"text" : "detune"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 140.0, 23.0, 18.0 ],
					"text" : "Hz"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 140.0, 44.0, 18.0 ],
					"prototypename" : "Live",
					"triangle" : 0,
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 59.0, 141.0, 45.0, 26.0 ],
					"rounded" : 15.0,
					"text" : "Off",
					"texton" : "On",
					"varname" : "on"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 121.0, 44.0, 18.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75,
					"varname" : "ramp"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 63.0, 102.0, 31.0, 18.0 ],
					"text" : "MIDI"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 159.0, 102.0, 40.0, 18.0 ],
					"prototypename" : "Live",
					"triangle" : 0,
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 102.0, 31.0, 18.0 ],
					"prototypename" : "Live",
					"triangle" : 0,
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 111.0, 140.0, 34.0, 18.0 ],
					"text" : "Pitch:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 67.0, 122.0, 36.0, 15.0 ],
					"prototypename" : "pitch",
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_speedlim" : 1.0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 74.0, 425.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 423.0, 101.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"pattrstorage" : "Yam",
					"presentation" : 1,
					"presentation_rect" : [ 213.0, 102.0, 103.0, 65.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"restore" : 					{
						"Brightness[1]" : [ 65.51181 ],
						"Damping[1]" : [ 60.184662 ],
						"Dry/Wet" : [ 66.0 ],
						"ExcitationLPosX" : [ 56.0 ],
						"ExcitationLPosY" : [ 53.0 ],
						"ExcitationRPosX" : [ 49.0 ],
						"ExcitationRPosY" : [ 52.0 ],
...
, 			{
				"box" : 				{
					...
					"pictures" : [  ],
					"presentation" : 1,
					"presentation_rect" : [ 67.0, 1.0, 109.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ -1.0, 0.0, 499.0, 491.0 ],
					"prototypename" : "M4L.horizontal-black",
					"rounded" : 16
				}
