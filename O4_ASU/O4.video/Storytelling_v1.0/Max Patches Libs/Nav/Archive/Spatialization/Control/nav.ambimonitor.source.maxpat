{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ -1070.0, 467.0, 449.0, 470.0 ],
		"bgcolor" : [ 0.407843, 0.396078, 0.482353, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ -1070.0, 467.0, 449.0, 470.0 ],
		...
		"enablevscroll" : 0,
		"devicewidth" : 0.0,
		"title" : "nav.ambinav.ambimonitor.source",
		"boxes" : [ 			{
				"box" : 				{
					"fontname" : "Arial",
					"fontsize" : 12.0,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 251.0, 114.0, 59.5, 20.0 ],
					"restore" : 					{
						"InterpolationMode" : [ 0 ],
						"MonitorMode" : [ 0 ],
						"grid" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 292.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 292.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ -1776.0, 538.0, 276.0, 199.0 ],
						"bglocked" : 0,
						"defrect" : [ -1776.0, 538.0, 276.0, 199.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
...
,
					"patching_rect" : [ 218.39917, 439.874268, 50.0, 20.0 ],
...
,
					"patching_rect" : [ 227.0, 201.0, 107.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 84.0, 1.0, 35.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.747437, 559.02063, 111.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 102.747437, 534.278381, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 382.747437, 1.0, 40.0, 17.0 ],
					"types" : [  ],
					"varname" : "InterpolationMode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.634766, 518.704468, 59.0, 15.0 ],
					"text" : "interval $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 263.634766, 493.092773, 39.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 423.634766, 1.0, 28.0, 17.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
					"varname" : "interval"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 186.0, 544.0, 88.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 163.0, 493.0, 91.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 1.0, 67.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 189.0, 517.0, 43.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 202.0, 1.0, 29.0, 17.0 ],
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"textcolor2" : [ 1.0, 1.0, 1.0, 1.0 ],
					"togcolor" : [ 0.552941, 0.552941, 0.552941, 1.0 ],
					"types" : [  ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 430.0, 118.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 286.0, 1.0, 56.0, 17.0 ],
					"text" : "interpolate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 449.0, 108.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 13.0, 430.0, 38.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 339.0, 1.0, 43.0, 17.0 ],
					"triangle" : 0,
					"triscale" : 0.9,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 164.0, 401.0, 99.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 12.0, 467.0, 61.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 231.0, 1.0, 54.0, 15.0 ],
					"text" : "remove_all"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 41.0, 1.0, 29.0, 15.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.0, 1.0, 17.0, 17.0 ],
					"types" : [  ],
					"varname" : "grid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 6.0, 142.0, 142.857147, 142.857147 ],
					"point_color" : [ 0.827451, 0.737255, 0.835294, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 19.0, 452.0, 452.0 ],
					"varname" : "source"
				}
