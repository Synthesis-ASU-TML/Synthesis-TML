{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 273.0, 106.0, 874.0, 538.0 ],
		"bglocked" : 0,
		"defrect" : [ 273.0, 106.0, 874.0, 538.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 659.0, 497.0, 25.0, 25.0 ],
					"presentation_rect" : [ 659.0, 497.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 677.0, 231.0, 110.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 676.0, 454.0, 194.0, 19.0 ],
					"presentation_rect" : [ 676.0, 454.0, 0.0, 0.0 ],
					"text" : "rogs~ 1 80 #0_buffer 10. 0. 0. 320."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 230.0, 380.0, 50.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 633.0, 185.0, 153.0, 19.0 ]
				}
...
,
					"patching_rect" : [ 80.393799, 265.700195, 107.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 686.0, 159.0, 68.0, 19.0 ],
					"text" : "s #0.return"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 686.0, 132.0, 104.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.0, 65.0, 106.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 365.0, 190.0, 107.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 697.0, 109.0, 100.0, 17.0 ],
					"text" : "s #0_sampLength"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 604.0, 87.0, 113.5, 17.0 ],
					"text" : "info~ #0_buffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 462.0, 68.0, 19.0 ],
					"text" : "r #0.return"
				}
...
,
					"patching_rect" : [ 479.0, 346.0, 50.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontname" : "Arial",
						"fontface" : 0,
						"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 44.0, 197.0, 205.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 489.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 360.0, 279.0, 218.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 220.0, 279.0, 86.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 344.0, 39.0, 17.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 369.0, 36.0, 19.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 80.0, 80.0, 262.0, 19.0 ],
					"text" : "jcom.oscroute /position /pitch /grain /buffer /turn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 481.0, 221.0, 110.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 489.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 446.0, 463.0, 194.0, 19.0 ],
					"text" : "rogs~ 1 80 #0_buffer 10. 0. 0. 320."
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"hidden" : 0,
					"midpoints" : [ 138.100006, 182.0, 229.5, 182.0 ],
					"source" : [ "obj-11", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 186.699997, 248.0, 369.5, 248.0 ],
					"source" : [ "obj-11", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 2 ],
					"hidden" : 0,
					"midpoints" : [ 89.5, 441.0, 743.833313, 441.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 2 ],
					"hidden" : 0,
					"midpoints" : [ 89.5, 447.0, 513.833313, 447.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 3 ],
					"hidden" : 0,
					"midpoints" : [ 53.5, 441.0, 773.0, 441.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 3 ],
					"hidden" : 0,
					"midpoints" : [ 53.5, 430.0, 543.0, 430.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 5 ],
					"hidden" : 0,
					"midpoints" : [ 263.0, 333.0, 831.333313, 333.0 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 4 ],
					"hidden" : 0,
					"midpoints" : [ 229.5, 333.0, 802.166687, 333.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 5 ],
					"hidden" : 0,
					"midpoints" : [ 263.0, 381.5, 601.333313, 381.5 ],
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 4 ],
					"hidden" : 0,
					"midpoints" : [ 229.5, 402.5, 572.166687, 402.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 6 ],
					"hidden" : 0,
					"midpoints" : [ 435.833344, 441.0, 860.5, 441.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 502.166656, 321.5, 488.5, 321.5 ],
					"source" : [ "obj-18", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 6 ],
					"hidden" : 0,
					"midpoints" : [ 435.833344, 320.0, 630.5, 320.0 ],
					"source" : [ "obj-18", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 488.5, 441.0, 685.5, 441.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"hidden" : 0,
					"midpoints" : [ 686.5, 441.0, 685.5, 441.0 ],
					"source" : [ "obj-8", 0 ]
				}
