{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 154.0, 172.0, 1018.0, 799.0 ],
		"bglocked" : 0,
		"defrect" : [ 154.0, 172.0, 1018.0, 799.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 517.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 249.0, 92.0, 45.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 103.909058, 46.454544, 53.0, 19.0 ],
					"triangle" : 0,
					"triscale" : 0.53,
					"varname" : "playSpeed"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 46.0, 90.0, 19.0 ],
					"text" : "speed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 494.0, 742.0, 559.0, 43.0 ],
					"text" : "jcom.parameter position/speed @type decimal @dataspace time @dataspace/unit/active millisecond @dataspace/unit/native millisecond @ramp/drive scheduler @range/bounds -10. 10. @range/clipmode both @description \"scrubing through the position\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 492.0, 876.0, 50.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 552.0, 876.0, 150.0, 19.0 ],
					"text" : "Turn"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 492.0, 896.0, 592.0, 31.0 ],
					"text" : "jcom.parameter turn @type decimal @dataspace time @dataspace/unit/active millisecond @dataspace/unit/native millisecond @ramp/drive scheduler @range/bounds 0. 3. @range/clipmode both @description spatialize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 493.0, 798.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 103.0, 117.0, 45.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 116.0, 84.0, 19.0 ],
					"text" : "Trigger (rate):"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 493.0, 818.0, 549.0, 43.0 ],
					"text" : "jcom.parameter grain/trigger @type decimal @dataspace time @dataspace/unit/active millisecond @dataspace/unit/native millisecond @ramp/drive scheduler @range/bounds 0. 200. @range/clipmode low @description \"grain rate\""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 30.0, 97.0, 19.0 ],
					"text" : "Audio Buffer"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 104.0, 66.0, 52.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 66.0, 90.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 26.0, 97.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 164.0, 113.0, 90.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 164.0, 93.0, 81.0, 19.0 ],
					"text" : "Transps(cent)"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 95.0, 90.0, 19.0 ],
					"text" : "Grain duration:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 26.0, 52.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 249.0, 113.0, 45.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 104.0, 97.0, 45.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 495.0, 240.0, 538.0, 31.0 ],
					"text" : "jcom.parameter grain/overlap @type integer @dataspace none @ramp/drive none @range/bounds 1 12 @range/clipmode both @description \"Set 2^i number of overlapping grains.\""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 244.0, 55.0, 39.0, 20.0 ],
					"text" : "View"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 180.0, 55.0, 59.0, 20.0 ],
					"text" : "Load File"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 194.0, 485.0, 139.0, 19.0 ],
					"text" : "jcom.out~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 71.0, 429.0, 56.0, 19.0 ],
					"text" : "jcom.in~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 194.0, 516.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 71.0, 459.0, 265.0, 19.0 ],
					"text" : "jalg.nav.stereo.rogs~ #0_"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 520.0, 107.0, 19.0 ],
					"text" : "---signal outputs---"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 21.0, 152.0, 69.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 93.0, 150.0, 43.0 ],
					"rounded" : 15
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 168.0, 30.0, 120.0, 48.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 164.0, 90.0, 135.0, 44.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 504.5, 479.0, 485.0, 479.0, 485.0, 370.0, 504.5, 370.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 501.5, 941.0, 477.0, 941.0, 477.0, 872.0, 501.5, 872.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"hidden" : 0,
					"midpoints" : [ 80.5, 552.0, 504.5, 552.0 ],
					"source" : [ "obj-51", 0 ]
				}
