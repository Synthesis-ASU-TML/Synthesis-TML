...
, 			{
				"box" : 				{
					"args" : [ "@name", "jmod.nav.ambispat~", "@description", "Dynamic wrapper for HOA proccessing with IRCAM's SPAT4." ],
					"bgmode" : 1,
					"id" : "obj-6",
					"maxclass" : "bpatcher",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 574.0, 431.0, 109.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "int" ],
					"patching_rect" : [ 583.067627, 454.465332, 34.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 176.067627, 77.0, 34.323135, 16.0 ],
					"rounded" : 8.729978,
					"text" : "view",
					"texton" : "view",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 583.067627, 493.0, 57.0, 21.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.0, 236.0, 132.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 112.0, 77.0, 51.0, 19.0 ],
					"text" : "#of srcs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 572.0, 230.0, 37.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 77.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 572.0, 306.0, 150.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 77.0, 97.0, 150.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 83.0, 300.0, 140.0 ],
...
,
					"patching_rect" : [ 8.0, 543.0, 47.0, 19.0 ],
					"presentation" : 1,
...
,
					"patching_rect" : [ 8.0, 438.0, 47.0, 19.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 8.0, 658.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 568.0, 636.0, 300.0, 70.0 ],
					"varname" : "/output~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 350.0, 446.0, 112.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 350.0, 227.0, 200.0, 200.0 ],
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 167.5, 417.5, 17.5, 417.5 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 733.5, 453.0, 563.0, 453.0, 563.0, 301.0, 581.5, 301.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"hidden" : 0,
					"midpoints" : [ 148.5, 650.0, 298.5, 650.0 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 298.5, 236.0, 17.5, 236.0 ],
					"source" : [ "obj-32", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 158.0, 236.0, 17.5, 236.0 ],
					"source" : [ "obj-32", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 707.5, 216.0, 581.5, 216.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 293.5, 567.0, 148.5, 567.0 ],
					"source" : [ "obj-41", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"hidden" : 0,
					"midpoints" : [ 359.5, 471.0, 325.0, 471.0, 325.0, 300.0, 167.5, 300.0 ],
					"source" : [ "obj-5", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"hidden" : 0,
					"midpoints" : [ 45.5, 569.0, 17.5, 569.0 ],
					"source" : [ "obj-61", 1 ]
				}
