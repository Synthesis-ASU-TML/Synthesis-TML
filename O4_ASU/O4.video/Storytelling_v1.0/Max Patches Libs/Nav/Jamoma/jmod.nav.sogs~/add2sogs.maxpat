...
,
					"patching_rect" : [ 18.0, 99.0, 147.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial Bold",
						"default_fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 18.0, 11.0, 40.0, 16.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 599.0, 20.0, 39.0, 15.0 ],
					"prototypename" : "onoff",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 50.0, 35.0, 48.0, 53.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 431.0, 87.0, 56.0, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 75.0, 19.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 531.0, 79.0, 19.0, 18.0 ],
					"text" : "^"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 87.0, 33.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 522.0, 83.0, 33.0, 18.0 ],
					"text" : "Root"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 162.0, 27.0, 103.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 479.0, 20.0, 103.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 82.0, 11.0, 31.0, 15.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 435.0, 21.0, 28.0, 14.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 114.0, 43.0, 203.0, 34.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 436.0, 45.0, 203.0, 34.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 307.5, 87.5, 155.5, 87.5 ],
					"source" : [ "obj-79", 1 ]
				}
