...
,
		"rect" : [ 9.0, 44.0, 1234.0, 856.0 ],
		"bglocked" : 0,
		"defrect" : [ 9.0, 44.0, 1234.0, 856.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 359.0, 398.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 106.0, 556.0, 119.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 628.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 65.0, 97.0, 19.0 ],
					"text" : "speed"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 496.0, 628.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 65.0, 48.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 496.0, 647.0, 561.0, 43.0 ],
					"text" : "jcom.parameter position/speed @type decimal @dataspace time @dataspace/unit/active millisecond @dataspace/unit/native millisecond @range/bounds -10. 10. @range/clipmode none @ramp/drive scheduler @description speed."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 254.0, 277.0, 126.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 494.0, 699.0, 50.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 45.0, 48.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 554.0, 699.0, 150.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 45.0, 90.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 25.0, 97.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 116.0, 90.0, 19.0 ],
					"text" : "Grain duration:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 10.0, 96.0, 90.0, 19.0 ],
					"text" : "Grain overlap"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 25.0, 48.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 116.0, 48.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.0, 96.0, 48.0, 19.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 494.0, 719.0, 581.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 495.0, 415.0, 602.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 495.0, 510.0, 486.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 227.0, 486.0, 73.0, 19.0 ],
					"text" : "jcom.out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 227.0, 517.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "signal" ],
					"patching_rect" : [ 105.0, 460.0, 141.0, 19.0 ],
					"text" : "jalg.nav.mono.sogs~ #0_"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 512.0, 107.0, 19.0 ],
					"text" : "---signal outputs---"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 22.0, 150.0, 66.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 91.0, 150.0, 46.0 ],
					"rounded" : 15
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 115.5, 584.0, 310.0, 584.0, 310.0, 550.0, 504.5, 550.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 503.5, 764.0, 479.0, 764.0, 479.0, 695.0, 503.5, 695.0 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"hidden" : 0,
					"midpoints" : [ 505.5, 691.0, 481.0, 691.0, 481.0, 625.0, 505.5, 625.0 ],
					"source" : [ "obj-5", 0 ]
				}
