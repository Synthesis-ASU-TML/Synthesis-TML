...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 676.0, 266.0, 118.0, 20.0 ],
					"text" : "r #1-spdchange"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 494.0, 236.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 909.0, 548.0, 77.0, 20.0 ],
					"text" : "r #0-Impro"
				}
...
,
						"rect" : [ 493.0, 257.0, 343.0, 231.0 ],
						"bglocked" : 0,
						"defrect" : [ 493.0, 257.0, 343.0, 231.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 314.0, 372.0, 103.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"fontname" : "Arial",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 874.0, 678.0, 84.0, 20.0 ],
					"text" : "r #0-Enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 908.0, 733.0, 101.0, 20.0 ],
					"text" : "r #0-SVP-Sync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 341.0, 798.0, 77.0, 20.0 ],
					"text" : "r #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 498.0, 464.0, 92.0, 20.0 ],
					"text" : "s #0-DelData"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.81955, 94.477921, 92.0, 20.0 ],
					"text" : "s #0-bangout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.0, 92.0, 79.0, 20.0 ],
					"text" : "s #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 27.0, 998.0, 77.0, 20.0 ],
					"text" : "r #0-Impro"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.0, 251.0, 90.0, 20.0 ],
					"text" : "r #0-DelData"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 275.0, 348.0, 119.0, 20.0 ],
					"text" : "OMax.render #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 150.0, 103.0, 20.0 ],
					"text" : "s #0-SVP-Sync"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.0, 20.0, 101.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 216.0, 939.0, 84.0, 20.0 ],
					"text" : "r #0-Enable"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 256.0, 145.0, 86.0, 20.0 ],
					"text" : "s #0-Enable"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 201.0, 874.0, 90.0, 20.0 ],
					"text" : "r #0-bangout"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 196.0, 92.0, 20.0 ],
					"text" : "s #0-bangout"
				}
...
,
						...
						"enablevscroll" : 1,
						"devicewidth" : 0.0,
						"globalpatchername" : "#1Player1[4][3][3][4][4][4][1][1][4][6][1][1][1][1][1][1][1][1][1][2][4][1][2][2][2][2][2][3][3][3][3][3][1][4][4][4][4][4][4][1][4][4]",
						"boxes" : [ 							{
								"box" : 								{
									"comment" : "",
									"id" : "obj-8",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 959.0, 67.0, 20.0 ],
					"text" : "r #0-end"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 92.0, 69.0, 20.0 ],
					"text" : "s #0-end"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 422.0, 155.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.0, 822.0, 101.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 446.0, 101.0, 20.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "bang", "", "list", "list", "int" ],
					"patching_rect" : [ 381.0, 293.0, 119.0, 20.0 ],
					"text" : "OMax.render #1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 130.0, 167.241852, 141.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 101.0, 132.241852, 141.0, 20.0 ],
									"text" : "OMax.state2date #1"
								}
