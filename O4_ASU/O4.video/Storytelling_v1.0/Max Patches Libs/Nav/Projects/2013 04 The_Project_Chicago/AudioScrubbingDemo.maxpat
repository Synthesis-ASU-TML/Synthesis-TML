...
,
					"patching_rect" : [ 362.0, 708.0, 90.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 63.5, 561.0, 129.0, 20.0 ],
					"presentation_rect" : [ 51.0, 634.0, 0.0, 0.0 ],
					"text" : "7: turn audio on",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 204.5, 501.0, 129.0, 20.0 ],
					"presentation_rect" : [ 103.25, 535.0, 0.0, 0.0 ],
					"text" : "6: turn scubbing on",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.75, 619.0, 237.0, 47.0 ],
					"presentation_rect" : [ 558.25, 709.0, 0.0, 0.0 ],
					"text" : "5: import audio sample (aiff/wave)\nThe sample should ideally be short and without much internal silence",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 402.75, 442.0, 283.0, 34.0 ],
					"presentation_rect" : [ 409.25, 473.0, 0.0, 0.0 ],
					"text" : "4: smooth/interpolate\nand insert scaling if needed",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.25, 456.0, 104.0, 20.0 ],
					"text" : "scale 0. 1. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 113.0, 279.0, 20.0 ],
					"presentation_rect" : [ 5.0, 158.0, 0.0, 0.0 ],
					"text" : "2: adjust image if needed",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 394.25, 484.5, 47.0, 18.0 ],
					"text" : "$1 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 393.5, 503.5, 59.0, 20.0 ],
					"text" : "line 0. 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 394.25, 50.0, 285.0, 20.0 ],
					"presentation_rect" : [ 11.0, 231.0, 0.0, 0.0 ],
					"text" : "3: motionTracking",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 1.0, 280.0, 34.0 ],
					"text" : "1: input \n(choose soure, open camera, press toggle on)",
					"textcolor" : [ 0.564772, 0.000301, 0.169523, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 7.0, 133.0, 300.0, 105.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.5, 588.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 362.0, 619.0, 69.0, 25.0 ],
					"text" : "import"
				}
...
,
					"patching_rect" : [ 362.0, 678.0, 104.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 393.5, 529.0, 298.5, 18.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 166.0, 282.351562, 19.0 ],
									"presentation_rect" : [ 50.0, 166.0, 282.351562, 19.0 ],
...
,
					"patching_rect" : [ 323.5, 561.0, 89.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 323.5, 501.0, 46.0, 46.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 7.0, 35.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 7.0, 240.0, 300.0, 228.0 ]
				}
...
,
					"patching_rect" : [ 384.25, 151.0, 100.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Verdana",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 329.25, 422.0, 64.0, 20.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 678.25, 153.0, 60.0, 19.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 713.25, 188.0, 20.0, 240.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 394.25, 421.0, 320.0, 20.0 ],
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"setminmax" : [ 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 394.25, 182.0, 320.0, 240.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 394.25, 70.0, 300.0, 70.0 ],
					"presentation_rect" : [ 15.0, 15.0, 300.0, 70.0 ],
					"varname" : "/motion%"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 494.25, 151.0, 188.0, 19.0 ],
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 297.5, 237.0, 313.0, 237.0, 313.0, 12.0, 684.75, 12.0 ],
					"source" : [ "obj-3", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 403.75, 142.0, 393.75, 142.0 ],
					"source" : [ "obj-57", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 684.75, 177.0, 403.75, 177.0 ],
					"source" : [ "obj-57", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 403.75, 146.0, 499.25, 146.0, 499.25, 140.0, 503.75, 140.0 ],
					"source" : [ "obj-57", 0 ]
				}
