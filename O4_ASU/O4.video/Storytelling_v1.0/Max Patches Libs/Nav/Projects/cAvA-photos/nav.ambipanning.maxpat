{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 808.0, 156.0, 406.0, 589.0 ],
		"bgcolor" : [ 0.980392, 0.980392, 0.980392, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 808.0, 156.0, 406.0, 589.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 395.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 189.0, 299.0, 18.0, 18.0 ],
					"presentation_rect" : [ 189.0, 299.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 159.0, 300.0, 18.0, 18.0 ],
					"presentation_rect" : [ 159.0, 300.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 300.0, 18.0, 18.0 ],
					"presentation_rect" : [ 120.0, 300.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 84.0, 302.0, 18.0, 18.0 ],
					"presentation_rect" : [ 84.0, 302.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 302.0, 18.0, 18.0 ],
					"presentation_rect" : [ 126.0, 299.0, 0.0, 0.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 303.0, 18.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 206.0, 264.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 294.0, 27.0, 69.0, 20.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 294.0, 2.0, 89.0, 20.0 ],
					"text" : "loadmess 6 10"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 26.0, 65.0, 19.0 ],
					"text" : "distance"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 241.0, 46.0, 47.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 67.0, 124.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 130.0, 26.0, 112.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 135.0, 46.0, 37.0, 19.0 ],
					"triscale" : 0.9
				}
...
,
					"patching_rect" : [ 261.0, 147.0, 90.0, 17.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 224.0, 746.0, 296.0, 17.0 ],
...
,
					"patching_rect" : [ 262.0, 111.0, 90.0, 17.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"default_fontsize" : 10.0,
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 265.0, 48.0, 17.0 ],
					"text" : "r to_aep"
				}
...
,
					"patching_rect" : [ 261.0, 129.0, 90.0, 17.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"default_fontsize" : 10.0,
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 10.0, 59.0, 387.0, 241.0 ],
						"bglocked" : 0,
						"defrect" : [ 10.0, 59.0, 387.0, 241.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 10.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 8.0, 59.0, 73.0, 17.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"default_fontsize" : 10.0,
						"fontsize" : 10.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 179.0, 364.0, 99.5, 17.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3.0, 225.0, 77.0, 15.0 ],
					"text" : "open, loop 1, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 82.0, 59.0, 34.0, 15.0 ],
					"text" : "dump"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 195.0, 84.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 39.0, 81.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 8.0, 91.0, 100.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 135.0, 91.0, 100.0, 100.0 ],
					"point_color" : [ 0.496094, 0.996094, 0.996094, 1.0 ],
					"point_size" : 5.0,
					"presentation_rect" : [ 0.0, 0.0, 100.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 3.0, 242.0, 44.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 385.0, 349.0, 14.0, 81.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"overloadcolor" : [ 1.0, 0.498039, 0.0, 1.0 ],
					"patching_rect" : [ 371.0, 349.0, 14.0, 81.0 ],
					"tepidcolor" : [ 0.270588, 0.694118, 0.898039, 1.0 ],
					"warmcolor" : [ 0.388235, 0.168627, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"overloadcolor" : [ 1.0, 0.498039, 0.0, 1.0 ],
					"patching_rect" : [ 357.0, 349.0, 14.0, 81.0 ],
					"tepidcolor" : [ 0.270588, 0.694118, 0.898039, 1.0 ],
					"warmcolor" : [ 0.388235, 0.168627, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"overloadcolor" : [ 1.0, 0.498039, 0.0, 1.0 ],
					"patching_rect" : [ 343.0, 349.0, 14.0, 81.0 ],
					"tepidcolor" : [ 0.270588, 0.694118, 0.898039, 1.0 ],
					"warmcolor" : [ 0.388235, 0.168627, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"overloadcolor" : [ 1.0, 0.498039, 0.0, 1.0 ],
					"patching_rect" : [ 329.0, 349.0, 14.0, 81.0 ],
					"tepidcolor" : [ 0.270588, 0.694118, 0.898039, 1.0 ],
					"warmcolor" : [ 0.388235, 0.168627, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"overloadcolor" : [ 1.0, 0.498039, 0.0, 1.0 ],
					"patching_rect" : [ 315.0, 349.0, 14.0, 81.0 ],
					"tepidcolor" : [ 0.270588, 0.694118, 0.898039, 1.0 ],
					"warmcolor" : [ 0.388235, 0.168627, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 8.0, 332.0, 207.0, 17.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-126", 0 ],
					"hidden" : 0,
					"midpoints" : [ 144.5, 212.0, 17.5, 212.0 ],
					"source" : [ "obj-109", 0 ]
				}
