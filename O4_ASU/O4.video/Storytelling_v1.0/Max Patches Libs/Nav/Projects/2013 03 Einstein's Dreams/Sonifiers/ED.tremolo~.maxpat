...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 621.0, 151.0, 300.0, 70.0 ],
					"presentation_rect" : [ 647.0, 269.0, 300.0, 70.0 ],
					"varname" : "jmod.tremolo~[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 621.0, 228.0, 300.0, 140.0 ],
					"presentation_rect" : [ 647.0, 376.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 621.0, 3.0, 300.0, 140.0 ],
					"presentation_rect" : [ 647.0, 109.0, 300.0, 140.0 ],
					"varname" : "jmod.input~[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 312.0, 151.0, 300.0, 70.0 ],
					"presentation_rect" : [ 338.0, 268.0, 300.0, 70.0 ],
					"varname" : "jmod.tremolo~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 312.0, 228.0, 300.0, 140.0 ],
					"presentation_rect" : [ 338.0, 375.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 338.0, 108.0, 300.0, 140.0 ],
					"varname" : "jmod.input~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 4.0, 151.0, 300.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 4.0, 228.0, 300.0, 140.0 ],
...
, 			{
				"name" : "jmod.tremolo~.maxpat",
				"bootpath" : "/Applications/Max6/Cycling '74/Jamoma/modules/audio/tremolo~",
				"patcherrelativepath" : "../../../../../../Applications/Max6/Cycling '74/Jamoma/modules/audio/tremolo~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "jalg.tremolo~.maxpat",
				"bootpath" : "/Applications/Max6/Cycling '74/Jamoma/modules/audio/tremolo~",
				"patcherrelativepath" : "../../../../../../Applications/Max6/Cycling '74/Jamoma/modules/audio/tremolo~",
				"type" : "JSON",
				"implicit" : 1
