...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 638.0, 10.0, 274.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 31.0, 354.0, 221.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 98.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 303.0, 354.0, 300.0, 70.0 ],
					"varname" : "/output~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 906.0, 82.5, 84.0, 17.0 ],
					"text" : "/audio/gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 906.0, 244.5, 84.0, 17.0 ],
					"text" : "/audio/gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 906.0, 401.5, 84.0, 17.0 ],
					"text" : "/audio/gain $1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 284.0, 600.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 606.0, 28.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 354.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 306.0, 142.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 303.0, 141.0, 300.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 303.0, 1.0, 300.0, 140.0 ],
					"varname" : "/input~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 3.0, 142.0, 300.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 141.0, 300.0, 140.0 ]
				}
