{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 0.0, 45.0, 760.0, 681.0 ],
		"bgcolor" : [ 0.368627, 0.368627, 0.368627, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 0.0, 45.0, 760.0, 681.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 628.0, 583.0, 27.0, 20.0 ],
					"text" : "del"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 455.0, 64.0, 300.0, 105.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 180.0, 52.0, 150.0 ],
									"text" : "/open \"/Users/navid/Desktop/cAvA Project/Vernisaage/SOunds/1/munged ducks.aif\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 45.0, 180.0, 52.0, 162.0 ],
									"text" : "/open \"/Users/navid/Desktop/cAvA Project/Vernisaage/SOunds/1/09 Fire,Crackle high.aif\""
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 140.0, 65.0, 300.0, 105.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 455.0, 3.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 981.0, 746.0, 37.0, 20.0 ],
					"text" : "s out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 981.0, 725.0, 83.5, 20.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 968.0, 458.0, 40.0, 20.0 ],
					"text" : "r vst2"
				}
...
,
					"patching_rect" : [ 828.0, 461.0, 57.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"fontname" : "Verdana",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 828.0, 491.0, 300.0, 210.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1007.0, 446.0, 37.0, 20.0 ],
					"text" : "s out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1007.0, 425.0, 83.5, 20.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 995.0, 159.0, 40.0, 20.0 ],
					"text" : "r vst1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 628.0, 558.0, 28.0, 20.0 ],
					"text" : "vst"
				}
...
,
					"patching_rect" : [ 854.0, 161.0, 57.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"fontname" : "Verdana",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 854.0, 191.0, 300.0, 210.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 331.0, 208.0, 55.0, 20.0 ],
					"text" : "r 2mng2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 140.0, 3.0, 300.0, 70.0 ]
				}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 654.0, 617.0, 33.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 12.0,
						"fontname" : "Arial",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 307.0, 357.0, 450.0, 140.0 ],
					"varname" : "munger[1]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 307.0, 477.0, 300.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 307.0, 173.0, 450.0, 140.0 ],
					"varname" : "munger"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 307.0, 293.0, 300.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 305.0, 608.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 307.0, 536.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 628.0, 536.0, 26.0, 20.0 ],
					"text" : "m2"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 628.0, 521.0, 26.0, 20.0 ],
					"text" : "m1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 651.0, 506.0, 37.0, 20.0 ],
					"text" : "N   L "
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.0, 292.0, 68.0, 90.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 651.0, 521.0, 35.0, 83.0 ]
				}
