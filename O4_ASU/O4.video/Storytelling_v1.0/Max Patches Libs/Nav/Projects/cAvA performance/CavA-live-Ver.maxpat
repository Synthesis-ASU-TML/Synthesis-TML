{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 6.0, 44.0, 776.0, 664.0 ],
		"bgcolor" : [ 0.368627, 0.368627, 0.368627, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 6.0, 44.0, 776.0, 664.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 456.0, 751.0, 37.0, 20.0 ],
					"text" : "s out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 456.0, 730.0, 87.5, 20.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 702.0, 570.0, 309.0, 145.0 ],
						"bglocked" : 0,
						"defrect" : [ 702.0, 570.0, 309.0, 145.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					"patching_rect" : [ 406.0, 725.0, 39.0, 19.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 626.0, 539.0, 39.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 406.0, 651.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 316.0, 510.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 588.0, 37.0, 20.0 ],
					"text" : "s out"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 61.0, 567.0, 87.5, 20.0 ],
					"text" : "jcom.multi.in~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 376.0, 300.0, 210.0 ],
					"varname" : "jmod.vst~[1]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 106.0, 34.0, 20.0 ],
					"text" : "VST"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 6.0, 167.0, 300.0, 210.0 ],
					"varname" : "jmod.vst~"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 590.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 651.0, 403.0, 310.0, 145.0 ],
						"bglocked" : 0,
						"defrect" : [ 651.0, 403.0, 310.0, 145.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 627.0, 465.0, 39.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 317.0, 436.0, 300.0, 70.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"id" : "obj-7",
									"items" : [ "TC Near TC Near Port 1", ",", "to MaxMSP 1", ",", "to MaxMSP 2" ],
									"labelclick" : 1,
									"maxclass" : "umenu",
									"numinlets" : 1,
									"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 316.0, 187.0, 450.0, 140.0 ],
					"varname" : "munger[1]"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 316.0, 307.0, 300.0, 54.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 316.0, 583.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 318.0, 364.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 239.0, 50.0, 72.0, 20.0 ],
					"text" : "N   L  Ph P"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 239.0, 67.0, 67.0, 68.0 ]
				}
