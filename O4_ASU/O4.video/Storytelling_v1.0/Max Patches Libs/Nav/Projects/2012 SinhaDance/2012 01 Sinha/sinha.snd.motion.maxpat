...
,
		"rect" : [ 1331.0, 44.0, 305.0, 413.0 ],
		"bgcolor" : [ 0.858824, 0.858824, 0.858824, 1.0 ],
		"bglocked" : 0,
		"defrect" : [ 1331.0, 44.0, 305.0, 413.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 584.0, 32.0, 300.0, 70.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 96.957123, 29.0, 22.0 ],
					"rounded" : 15.0,
					"text" : "Off",
					"texton" : "On",
					"varname" : "pvar_aktive"
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 229.0, 139.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 462.0, 213.0, 100.0, 80.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 76.0, 107.0, 80.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 486.0, 154.0, 52.0, 32.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 50.0, 89.0, 44.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 341.0, 300.0, 70.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 203.0, 314.0, 17.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 28.0, 500.0, 120.0, 80.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 100.0, 251.0, 120.0, 80.0 ],
					"usedstrect" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 220.0, 251.0, 8.0, 80.0 ],
					"setminmax" : [ 0.0, 1.0 ],
...
,
						"rect" : [ 2293.0, 710.0, 157.0, 299.0 ],
						"bglocked" : 0,
						"defrect" : [ 2293.0, 710.0, 157.0, 299.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 1,
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 4.0, 277.0, 63.0, 21.0 ],
									"text" : "s motion"
								}
...
,
					...
					"presentation" : 1,
					"presentation_rect" : [ 101.0, 231.0, 89.0, 19.0 ],
					"saved_object_attributes" : 					{
						"fontface" : 0,
						"fontsize" : 12.0,
						"default_fontname" : "Verdana",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 246.0, 477.0, 59.0, 19.0 ],
					"text" : "route 0."
				}
...
, 			{
				"box" : 				{
					...
					"peakcolor" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 331.0, 117.0, 8.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"slidercolor" : [ 0.403922, 0.109804, 0.701961, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 23.0, 371.0, 300.0, 70.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 3.0, 159.0, 300.0, 70.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 32.5, 439.0, 145.5, 439.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"hidden" : 1,
					"midpoints" : [ 231.5, 473.0, 244.0, 473.0, 244.0, 464.0, 255.5, 464.0 ],
					"source" : [ "obj-36", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 470.5, 141.0, 495.5, 141.0 ],
					"source" : [ "obj-70", 0 ]
				}
