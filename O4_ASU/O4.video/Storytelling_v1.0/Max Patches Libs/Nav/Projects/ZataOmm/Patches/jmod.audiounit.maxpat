{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 1498.0, 76.0, 327.0, 580.0 ],
		"bglocked" : 0,
		"defrect" : [ 1498.0, 76.0, 327.0, 580.0 ],
...
,
					"patching_rect" : [ 24.0, 152.0, 57.0, 19.0 ],
					"saved_object_attributes" : 					{
						"default_fontsize" : 10.0,
						"globalpatchername" : "",
						"fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 0.0, 407.0, 308.0, 17.0 ],
					"text" : "/raw/voice.1/cc.2 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 437.0, 300.0, 140.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 2.0, 300.0, 140.0 ],
					"presentation_rect" : [ 0.0, 0.0, 300.0, 140.0 ],
					"varname" : "jmod.input~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "signal", "signal" ],
					"patching_rect" : [ 24.0, 182.0, 300.0, 210.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"hidden" : 0,
					"midpoints" : [ 33.5, 399.0, 298.5, 399.0 ],
					"source" : [ "obj-17", 0 ]
				}
