...
void max_jit_ys_pixelweightmat_bang(t_max_jit_ys_pixelweightmat *x);
void *max_jit_ys_pixelweightmat_class;
...
{	
	...
	setup((void*)&max_jit_ys_pixelweightmat_class,
			(method)max_jit_ys_pixelweightmat_new,
			(method)max_jit_ys_pixelweightmat_free, (short)sizeof(t_max_jit_ys_pixelweightmat), 
		0L, A_GIMME, 0);
