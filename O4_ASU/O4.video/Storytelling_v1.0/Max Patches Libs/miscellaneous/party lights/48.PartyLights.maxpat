...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.0, 585.0, 265.0, 33.0 ],
					"text" : "jit.gl.videoplane party @transform_reset 2 @depth_enable 0 @blend_enable 1 @layer 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.0, 539.0, 246.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1241.0, 20.0, 209.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 441.0, 12.0, 209.0, 47.0 ],
					"text" : "PartyLights"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 390.0, 285.0, 209.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 390.0, 320.0, 75.0, 20.0 ],
					"text" : "jit.gl.camera"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 78.0, 585.0, 265.0, 33.0 ],
					"text" : "jit.gl.videoplane party @transform_reset 2 @depth_enable 0 @blend_enable 1 @layer 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "jit_gl_texture", "", "" ],
					"patching_rect" : [ 65.0, 249.0, 310.0, 20.0 ],
...
,
					"patching_rect" : [ 835.0, 244.039734, 196.1875, 31.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.0, 255.0, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 315.0, 390.0, 150.0, 20.0 ],
					"text_width" : 61.0
				}
