...
, 			{
				"box" : 				{
					...
					"id" : "obj-31",
					"maxclass" : "bpatcher",
					"name" : "jmod.gl.gn.spirals%.maxpat",
					"numinlets" : 2,
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 420.0, 315.0, 150.0, 140.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 334.0, 429.0, 150.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 525.0, 225.0, 82.0, 20.0 ],
					"text" : "r all_modules"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 405.0, 480.0, 324.0, 20.0 ],
					"text" : "jit.gl.videoplane test @position -1.2 -1. 0. @scale 2.3 1.9 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 150.0, 240.0, 372.0, 20.0 ],
					"text" : "jit.window test @fsmenubar 0 @floating 1 @fsaa 1 @doublebuffer 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 240.0, 210.0, 20.0 ],
					"text" : "jit.gl.render test @fsaa 1 @antialias 1"
				}
...
, 			{
				...
				"patcherrelativepath" : "./ASU_video_workshop_2013_12_13/jamoma_shaders/jmod.gl.gn.spirals%",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
