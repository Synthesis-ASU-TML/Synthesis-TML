...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 15.0, 195.0, 597.0, 31.0 ],
					"text" : "jcom.hub @module_type video @algorithm_type jitter @description \"Generates a spiral pattern in screen space per pixel..\"",
					"varname" : "jcom.hub"
				}
